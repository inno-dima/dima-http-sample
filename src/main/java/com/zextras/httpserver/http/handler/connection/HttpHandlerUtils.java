...
public class HttpHandlerUtils {
    ...
    private HttpHandlerUtils(){throw new UnsupportedOperationException();}
    ...
    private static void writeHeadersAndContentToStream(HttpResponse response, OutputStream outputStream, StringBuilder httpHeaders) {
        try {
